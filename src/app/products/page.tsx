      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="mt-1 relative">
              <input
                ...
                onChange={(e) =>
                  setNewProduct({
                    ...newProduct,
                    safety_stock_days: Number(e.target.value),
                  })
                }
          ...
          <div>
            ...
            <div className="mt-1 relative">
              <input
                ...
                onChange={(e) =>
                  setNewProduct({
                    ...newProduct,
                    production_lead_time_days: Number(e.target.value),
                  })
                }
                className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="30"
            ...
            <p className="mt-1 text-sm text-gray-500">
              Time needed to produce new stock
            </p>
          </div>

          <div>
            <label
              htmlFor="shipping_lead_time"
              className="block text-sm font-medium text-gray-700"
            >
              Shipping Lead Time
            </label>
            <div className="mt-1 relative">
              <input
                ...
                onChange={(e) =>
                  setNewProduct({
                    ...newProduct,
                    shipping_lead_time: Number(e.target.value),
                  })
                }
                className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="15"
            ...
            <div className="mt-1 relative">
              <input
                ...
                onChange={(e) =>
                  setNewProduct({
                    ...newProduct,
                    max_stock_days: Number(e.target.value),
                  })
                }
                className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="90"
            ...
            <div className="mt-1 relative">
              <input
                ...
                onChange={(e) =>
                  setNewProduct({
                    ...newProduct,
                    current_stock_units: Number(e.target.value),
                  })
                }
                className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="1000"
      ...
      <div className="flex flex-col items-center justify-center min-h-[600px] p-6">
        <div className="text-center mb-6">
          ...
          <p className="mt-2 text-gray-500">
            It seems you haven't added any products yet.
          </p>
        </div>
        {!isAddingNew ? (
              ...
              <tr key={product.id}>
                ...
                <td className="px-6 py-4">
                  <EditableCell
                    ...
                    onSave={(value) =>
                      handleUpdate(product.id, "safety_stock_days", value)
                    }
                    type="number"
                  />
                </td>
                ...
                <td className="px-6 py-4">
                  <EditableCell
                    ...
                    onSave={(value) =>
                      handleUpdate(product.id, "shipping_lead_time", value)
                    }
                    type="number"
                  />
                </td>
                <td className="px-6 py-4">
                  <EditableCell
                    ...
                    onSave={(value) =>
                      handleUpdate(product.id, "max_stock_days", value)
                    }
                    type="number"
                  />
                </td>
                <td className="px-6 py-4">
                  <EditableCell
                    ...
                    onSave={(value) =>
                      handleUpdate(product.id, "current_stock_units", value)
                    }
                    type="number"
                  />
                </td>
